...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: "It can act, too — 33 tools now",
    body: "It went from 14 tools to 33, and the gap it closed was everything the screens could do and the chat could not. It can now set a lead's commercial value, set who owes the next move, record a proposal, complete or snooze a follow-up, set strategic value, link a deal to a company, reassign an owner and send outreach — as well as report data quality, deal pace, budget accuracy, the audit trail for one lead, dormant clients worth revisiting and the money going cold.",
