...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: "It can act, too — 40 tools now",
    body: "It went from 14 tools to 40, and the gap it closed was everything the screens could do and the chat could not. It can now add a lead, edit its fields, set its commercial value, move it through the stages, record a proposal, merge two companies, link or unlink a deal, complete or snooze a follow-up, set strategic value, reassign an owner, cancel a draft and send outreach — as well as report data quality, deal pace, budget accuracy, the audit trail for one lead, dormant clients worth revisiting and the money going cold. Every one of them runs as you, with your permissions.",
