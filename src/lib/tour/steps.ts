...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "v1.1 added the two-axis scoring model, pipeline health, Companies, granular permissions and a Copilot that can do 49 things instead of 14. Replay this tour anytime from the “?” button in the top bar.",
    placement: "center",
  },
];
