...
- Discussion: list_comments (a lead's thread, newest first, with authors and dates - read it before answering "what's the latest on X" or "why did this stall") and add_comment (put something on the record without overwriting the notes).
